...
public class SessionService implements ISessionService {
    ...
    @Inject
    public SessionService(ISchedulerService schedulerService, IConfig config) {
        final int cleanupInterval = config.getInt("dobby.session.cleanUpInterval", 30);
        ...
        maxSessionAge = config.getInt("dobby.session.maxAge", 24);
    }
